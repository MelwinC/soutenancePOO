...
/**
   Classe de definition d'un canvas dans lequel on peut afficher une grille IHM avec laquelle il est possible :<br>
...
public class CanvasIHM 
{
  ...
  /** Constructeur de l'ihm.<br>
      L'objet cree doit ensuite etre inserer dans une objet swing comme par exemple un Frame d'une fenetre principale.<br>
      La methode getPanel() retourne le Panel du CanvasIHM.<br>
  ...
  */
  ...
  // ======================================================================
  /** Affecte a une case de la grille la marque (couleur)
      @param marque une valeur de 1 a 10 (couleur) ou 0 (case vide)
  ...
  */
  ...
  /** Ajout d'une ligne de (x1,y1) a (x2,y2) et de couleur.
      @param couleur (valeur de 1 a 10)
      @param x1
      @param y1
      @param x2
      @param y2
  ...
  */
  ...
  /** Retourne la marque de la case
      @param x coordonnee en x de la case
      @param y coordonnee en y de la case
      @return la valeur de la case (de 0 a 10)
  */
  ...
  // ======================================================================
  /** Teste si la case est libre (differente de 0)
      @param x coordonnee en x de la case
      @param y coordonnee en y de la case
  ...
  */
  ...
  class SourisAction extends MouseAdapter
  {
    ...
    public void mouseClicked(MouseEvent e)
    {
      if (_afficherGrille)
        {
          // On determine la case selectionnee
